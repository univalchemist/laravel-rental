        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Host Banners Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['url' => ADMIN_URL.'/edit_host_banners/'.$result->id, 'class' => 'form-horizontal', 'files' => true]) !!}
            <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <p class="note_text">(Note: Upload size minimum 660px * 345px)</p>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('link_title', $result->link_title, ['class' => 'form-control', 'id' => 'input_link_title', 'placeholder' => 'Link Title']) !!}
                ...
                <div class="panel" ng-init="translations = {{json_encode(old('translations') ?: $result->translations)}}; removed_translations =  []; errors = {{json_encode($errors->getMessages())}};">
                  ...
                  <div class="panel-body" ng-init="languages = {{json_encode($languages)}}">
                    ...
                    <div class="row" ng-repeat="translation in translations">
                      ...
                      <div class="form-group">
                        <label for="input_title_@{{$index}}" class="col-sm-3 control-label">Title<em class="text-danger">*</em></label>
                        <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label for="input_description_@{{$index}}" class="col-sm-3 control-label">Description<em class="text-danger">*</em></label>
                        <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label for="input_link_title_@{{$index}}" class="col-sm-3 control-label">Link Title<em class="text-danger">*</em></label>
                        <div class="col-sm-6">
                          {!! Form::text('translations[@{{$index}}][link_title]', '@{{translation.link_title}}', ['class' => 'form-control', 'id' => 'input_link_title_@{{$index}}', 'placeholder' => 'Link Title']) !!}
                          <span class="text-danger ">@{{ errors['translations.'+$index+'.link_title'][0] }}</span>
                        </div>
                      </div>
