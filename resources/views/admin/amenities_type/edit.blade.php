        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Amenities Type Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => ADMIN_URL.'/edit_amenities_type/'.$result->id, 'class' => 'form-horizontal','id'=>'form']) !!}
