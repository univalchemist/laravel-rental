        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Bottom Slider Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => ADMIN_URL.'/add_bottom_slider', 'class' => 'form-horizontal', 'files' => true]) !!}
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  <label for="input_description" class="col-sm-3 control-label">Title</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label for="input_position" class="col-sm-3 control-label">Description</label>
                  <div class="col-sm-6">
                    {!! Form::textarea('description', '', ['class' => 'form-control', 'id' => 'input_position']) !!}
                  </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  <label for="input_position" class="col-sm-3 control-label">Order</label>
                  <div class="col-sm-6">
                    {!! Form::text('order', 0, ['class' => 'form-control', 'id' => 'input_position']) !!}
                  </div>
                </div>
                <div class="form-group">
                  <label for="input_status" class="col-sm-3 control-label">Status</label>
                  <div class="col-sm-6">
