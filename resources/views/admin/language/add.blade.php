      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['url' => ADMIN_URL.'/add_language', 'class' => 'form-horizontal']) !!}
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::select('is_translatable', array('1' => 'Yes', '0' => 'No'), '', ['class' => 'form-control', 'id' => 'input_is_translatable', 'placeholder' => 'Select']) !!}
