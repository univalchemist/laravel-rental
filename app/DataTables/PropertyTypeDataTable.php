    ...
    public function ajax()
    {
        ...
        return $this->datatables
            ...
            ->addColumn('action', function ($property_type) {   
                return '<a href="'.url(ADMIN_URL.'/edit_property_type/'.$property_type->id).'" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;<a class="btn btn-xs btn-primary" data-href="'.url(ADMIN_URL.'/delete_property_type/'.$property_type->id).'" data-toggle="modal" data-target="#confirm-delete"><i class="glyphicon glyphicon-trash"></i></a>';
            })
            ->make(true);
    }
