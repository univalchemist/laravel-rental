 ...
 <footer class="page-container-responsive" ng-controller="footer">
  <div class="row row-condensed">
    ...
    <div class="col-md-3 col-md-offset-1 th_foot">
...
<div class="select select-large select-block row-space-2">
  ...
  {!! Form::select('currency',$currency, (Session::get('currency')) ? Session::get('currency') : $default_currency[0]->code, ['class' => 'currency-selector footer-select', 'aria-labelledby' => 'currency-selector-label', 'id' => 'currency_footer']) !!}
    ...
    <div class="col-md-2 col-md-offset-1 hide-sm footer_home2">
      ...
      @endforeach
       <li> <a href="{{ url('contact') }}" class="link-contrast">{{ trans('messages.contactus.contactus') }}</a></li>
      </ul>
    </div>
    ...
    <div class="col-md-2 hide-sm footer_home3">
 ...
 <!--  <div class="col-sm-12 space-4 space-top-4 show-sm footrem">
  ...
  <hr class="space-top-4 space-4 hide-sm row">
  ...
  <div class="">
    ...
    <div class="space-top-2 text-muted text-left pull-left float-none-sm">
      © {{ $site_name }}, Inc.
    </div>
  </div>
</footer>
