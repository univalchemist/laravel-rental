<div class="subnav hide-print">
  <div class="page-container-responsive">
    <ul class="subnav-list">
      ...
      <li>
        <a href="{{ url('disputes') }}" class="subnav-item" aria-selected="{{(Route::current()->uri() == 'disputes' ) ? 'true' : 'false'}}">{{ trans('messages.disputes.disputes') }}
        @if(Auth::user()->dispute_messages_count > 0)
        <i>{{ Auth::user()->dispute_messages_count }}</i>
        @endif
        </a>
      </li>
    </ul>
