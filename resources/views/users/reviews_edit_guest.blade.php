...
<div class="page-container page-container-responsive">
  <div class="row row-space-top-4 row-space-8">
    ...
    <div class="col-offset-1 col-7 tr_vier">
...
<div class="text-lead row-space-4">
  ...
  <section class="row-space-4">
    ...
    <textarea rows="2" placeholder="{{ trans('messages.lys.add_photo') }},{{ trans('messages.lys.amenities') }}" name="accuracy_comments" id="review_accuracy_comments" cols="40" class="input-large row-space-top-2 threshold-comment">{{ @$result->review_details($review_id)->accuracy_comments }}</textarea>
  </section>
  <section class="row-space-4">
    <div class="h3 row-space-1">
    ...
    <textarea rows="2" placeholder="{{ trans('messages.lys.add_photo') }},{{ trans('messages.lys.amenities') }}" name="cleanliness_comments" id="review_cleanliness_comments" cols="40" class="input-large row-space-top-2 threshold-comment">{{ @$result->review_details($review_id)->cleanliness_comments }}</textarea>
  </section>
  <section class="row-space-4">
    <div class="h3 row-space-1">
    ...
    <textarea rows="2" placeholder="{{ trans('messages.lys.add_photo') }},{{ trans('messages.lys.amenities') }}" name="checkin_comments" id="review_checkin_comments" cols="40" class="input-large row-space-top-2 threshold-comment">{{ @$result->review_details($review_id)->checkin_comments }}</textarea>
  </section>
  <section class="row-space-4">
    <div class="h3 row-space-1">
    ...
    <textarea rows="2" placeholder="{{ trans('messages.lys.add_photo') }},{{ trans('messages.lys.amenities') }}" name="amenities_comments" id="review_amenities_comments" cols="40" class="input-large row-space-top-2 threshold-comment">{{ @$result->review_details($review_id)->amenities_comments }}</textarea>
  </section>
  <section class="row-space-4">
    <div class="h3 row-space-1">
    ...
    <textarea rows="2" placeholder="{{ trans('messages.lys.add_photo') }},{{ trans('messages.lys.amenities') }}" name="communication_comments" id="review_communication_comments" cols="40" class="input-large row-space-top-2 threshold-comment">{{ @$result->review_details($review_id)->communication_comments }}</textarea>
  </section>
  <section class="row-space-4">
    <div class="h3 row-space-1">
    ...
    <textarea rows="2" placeholder="{{ trans('messages.lys.add_photo') }},{{ trans('messages.lys.amenities') }}" name="location_comments" id="review_location_comments" cols="40" class="input-large row-space-top-2 threshold-comment">{{ @$result->review_details($review_id)->location_comments }}</textarea>
  </section>
  <section class="row-space-4">
    <div class="h3 row-space-1">
    ...
    <textarea rows="2" placeholder="{{ trans('messages.lys.add_photo') }},{{ trans('messages.lys.amenities') }}" name="value_comments" id="review_value_comments" cols="40" class="input-large row-space-top-2 threshold-comment">{{ @$result->review_details($review_id)->value_comments }}</textarea>
  </section>
...
<section class="row-space-4 row-space-top-6">
  ...
  <input type="radio" value="0" name="recommend" id="review_recommend_0" {{ (@$result->review_details($review_id)->recommend == 1) ? 'checked="true"' : '' }}>
  ...
  <input type="radio" value="1" name="recommend" id="review_recommend_1" {{ (@$result->review_details($review_id)->recommend == 0) ? 'checked="true"' : '' }}>
