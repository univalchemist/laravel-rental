...
@section('main')
    ...
    <main id="site-content" role="main" ng-controller="search-page" ng-init="setParams()">
        <div class="home_filter" ng-init="opened_filter = '';">
            <ul ng-cloak>
                <li>
                    <button class="dbdate" ng-class="filter_active('dates')" data-target-filter="dates"
                            ng-click="update_opened_filter('dates')">
                ...
                <li class="frt">
                    <button class="guestbut newt" id="gue1" data-target-div="guet1" data-target-filter="guests"
                            ng-class="filter_active('guests')" ng-click="update_opened_filter('guests')">
                        ...
                        <div class="nameguest nameguest1">
                            <div class="forgu">
                                ...
                                <div class="valunum" ng-init="search_guest={{$guest}}">
                                    <button ng-disabled="search_guest==1" class="value-button" id="decrease"
                                            ng-click="search_guest=search_guest-1" value="Decrease Value">-
                                    </button>
                                    <input type="text" class="guest-select" ng-value="search_guest+'+'" readonly=""/>
                                    <button ng-disabled="search_guest == 16" class="value-button" id="increase"
                                            ng-click="search_guest=search_guest-0+1" value="Increase Value">+
                                    </button>
                                </div>
                            </div>
                            <div class="newed">
                                <span class="newcan"><a href="javascript:void(0)" class="close_target"
                                                        ng-click="reset_filters('guests')">{{ trans('messages.your_reservations.cancel') }}</a></span>
                                <span class="newapp"><a href="javascript:void(0)"
                                                        ng-click="apply_filters('guests')">{{ trans('messages.payments.apply') }}</a></span>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="frt hide">
                    <button class="guestbut newt" id="gue1" data-target-div="guet1">
                        <span>5 Guest,</span>
                        <span>1 infant</span>
                    </button>
                </li>
                <li class="frt room-type-filter">
                    <button class="guestbut newt1" id="gue2" data-target-div="guet2" data-target-filter="room_types"
                            ng-class="filter_active('room_types')" ng-click="update_opened_filter('room_types')">
                    ...
                    <div class="guestbut1" id="guet2">
                        <div class="nameguest nameguest2">
                                    ...
                                    <div class="foredhole">
                                        <div class="checking">
                                            <input type="checkbox" value="{{ $row->id }}" id="room_type_{{ $row->id }}"
                                                   class="regular-checkbox big-checkbox room-type"
                                                    {{in_array($row->id, $room_type_selected)  ? "checked" : ""}} />
                                            <label for="room_type_{{ $row->id }}"></label>
                                        </div>
                            ...
                            <div class="newed">
                                <span class="newcan">
                                    <a href="javascript:void(0)" class="close_target"
                                       ng-click="reset_filters('room_types')">
                                        {{ trans('messages.your_reservations.cancel') }}
                                    </a>
                                </span>
                                <span class="newapp">
                                    <a href="javascript:void(0)"
                                       ng-click="apply_filters('room_types')">
                ...
                <li class="frt" ng-init="currency_symbol = '{{ $currency_symbol }}'">
                    <button class="guestbut newt2" id="gue3" data-target-div="guet3"
                            ng-class="filter_active('prices')"
                            ng-click="update_opened_filter('prices')">
                    ...
                    <div class="guestbut1" id="guet3">
                        <div class="nameguest nameguest3">
                            ...
                            <div class="newed">
                                <span class="newcan">
                                    <a href="javascript:void(0)" class="close_target"
                                       ng-click="reset_filters('prices')">
                                        {{ trans('messages.your_reservations.cancel') }}
                                    </a>
                                </span>
                                <span class="newapp">
                                    <a href="javascript:void(0)"
                                       ng-click="apply_filters('prices')">
                                        {{ trans('messages.payments.apply') }}
                                    </a>
                                </span>
                            </div>
                ...
                <li class="frt">
                    <button class="guestbut" data-target-div="guet4" data-target-div="guet4"
                            ng-class="filter_active('instant_book')"
                            ng-click="update_opened_filter('instant_book')">{{trans('messages.lys.instant_book')}}
                    </button>
                            ...
                            <div class="checkhole">
                                ...
                                <div class="checkmore">
                                    <span class="checkbox " ng-class="instant_book == '1' ? '' : 'sdcheck'">
                                      <input type="checkbox" class="edfocus" name="instant_book"
                                             id="instant_book" ng-model="instant_book"
                                             ng-init="instant_book = '{{$instant_book}}'"
                                ...
                                <div class="newed">
                                    <span class="newcan">
                                        <a href="javascript:void(0)" class="close_target"
                                           ng-click="reset_filters('instant_book')">
                                            {{ trans('messages.your_reservations.cancel') }}
                                        </a>
                                    </span>
                                    <span class="newapp">
                                        <a href="javascript:void(0)"
                                           ng-click="apply_filters('instant_book')">
                                            {{ trans('messages.payments.apply') }}
                                        </a>
                                    </span>
                                </div>
                ...
                <li class="frt">
                    <button class="gut" data-target-filter="more_filters" ng-class="filter_active('more_filters')"
                            ng-click="update_opened_filter('more_filters')">
                        {{trans('messages.search.more_filters')}}
                        <span ng-if="is_filter_active('more_filters')">@{{filter_btn_text('more_filters')}}</span>
                    </button>
                </li>
                <li class="frt1">
                    <button class="gut5 gtnew" ng-class="filter_active('dates')" data-target-filter="dates"
                            ng-click="update_opened_filter('dates')">
                        <span ng-if="!is_filter_active('dates')">  {{ trans('messages.your_trips.dates') }}</span>
                        <span ng-if="is_filter_active('dates')">@{{format_date(checkin, 'DD MMM')}}-@{{format_date(checkout, 'DD MMM')}}</span>
                    </button>
                ...
                <li class="frt1">
                    <button class="gut1 gtnew" data-target-filter="filters" ng-class="filter_active('filters')"
                            ng-click="update_opened_filter('filters')">
        ...
        <div class="map-search">
            <div class="sidebar">
                <div class="sidesear">
                    ...
                    <input type="hidden" id="redo_search_value"
                           value="{{ trans('messages.search.redo_search_name') }} ">
                        ...
                        <div class="filters collapse" style="bottom: 606px;">
                                    ...
                                    <form class="col-lg-9 trip-form right-pull">
                                        <div class="row row-condensed">
                                            <div class="col-md-4 col-sm-6 row-space-1-sm">
                                                ...
                                                <input ng-model="checkin" readonly="readonly" autocomplete="off"
                                                       type="text" ng-change="search_result();"
                                                       placeholder="{{ trans('messages.home.checkin') }}"
                                                       ng-init="checkin = '{{ $checkin }}'" style="display:none;">

                                                <input readonly="readonly" autocomplete="off" id="checkin" type="text"
                                                       onfocus="this.blur()"
                                                       class="checkin tour-target ui-datepicker-target"
                                                       placeholder="{{ trans('messages.home.checkin') }}"
                                                       value="{{ $st_date }}">
                                            ...
                                            <div class="col-md-4 col-sm-6 row-space-1-sm">
                                                ...
                                                <input readonly="readonly" onfocus="this.blur()" ng-model="checkout"
                                                       autocomplete="off" type="text" ng-change="search_result();"
                                                       class="checkout tour-target ui-datepicker-target "
                                                       placeholder="{{ trans('messages.home.checkout') }}"
                                                       ng-init="checkout = '{{ $checkout }}'" style="display:none;">


                                                <input readonly="readonly" onfocus="this.blur()" autocomplete="off"
                                                       id="checkout" type="text"
                                                       class="checkout tour-target ui-datepicker-target "
                                                       placeholder="{{ trans('messages.home.checkout') }}"
                                                       value="{{ $end_date }}">
                                            ...
                                            <div class="container_mv0xzc-o_O-borderLeft_1ujj4hk-o_O-borderRight_1x9yfnn"
                                                ...
                                                <div class="webcot-lg-datepicker webcot-lg-datepicker--jumbo">
                                                    <div class="dateRangePicker_e296pg-o_O-_ajz5vs"></div>
                                                </div>
                            ...
                            <div id="search_more_filter">
                                            ...
                                            <div class="row row-condensed">
                                                <div class="col-md-4 col-sm-12 row-space-1">
                                                    <div class="select select-block">
                                                        ...
                                                        <select name="min_bedrooms" ng-model="bedrooms"
                                                                class="min-bedrooms" id="map-search-min-bedrooms"
                                                                ng-init="bedrooms = '{{ $bedrooms }}'">
                                                ...
                                                <div class="col-md-4 col-sm-12 row-space-1">
                                                    <div class="select select-block">
                                                        <label for="map-search-min-bathrooms"
                                                               class="screen-reader-only">
                                                            {{ trans('messages.search.minimum_bathroms') }}
                                                        </label>
                                                        <select name="min_bathrooms" ng-model="bathrooms"
                                                                class="min-bathrooms input-medium"
                                                                id="map-search-min-bathrooms"
                                                                ng-init="bathrooms = '{{ $bathrooms }}'">
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="select select-block">
                                                        ...
                                                        <select name="min_beds" ng-model="beds"
                                                                class="min-beds input-medium" id="map-search-min-beds"
                                                                ng-init="beds = '{{ $beds }}'">
                                ...
                                @if($amenities->count() > 0)
                                    <div class="checkbox-group hosting_amenities filters-section panel-body panel-light toggle-group"
                                                ...
                                                <div class="row row-condensed filters-columns">
                                                    ...
                                                    @foreach($amenities as $row_amenities)
                                                        @if($row_inc <= 3)
                                                            ...
                                                            <div class="col-md-4">
                                                                <label class="media checkbox text-truncate"
                                                                       title="{{ $row_amenities->name }}">
                                                                    <input type="checkbox" name="more_filter[]"
                                            ...
                                            <div class="row row-condensed space-sm-7">
                                                <div class="col-sm-offset-4 col-sm-4 apply-btn">
                                                    <button class="btn btn-block cancel-btn"
                                                            id="cancel-filter">{{ trans('messages.your_reservations.cancel') }}</button>
                                                </div>
                                                <div class="col-sm-4 apply-red">
                                                    <button class="btn btn-block btn-primary apply-filters-btn"
                                                            id="more_filter_submit" disabled="disabled"
                                                            {{ (count($amenities_selected) || count($property_type_selected)) ? '' : 'disabled' }} ng-click="apply_filter();">
                    ...
                    <div class="search-results toggle-hide back-change"
                         ng-init="bed_text='{{ trans_choice("messages.lys.bed",1) }}'; beds_text='{{ trans_choice("messages.lys.bed",2)}}'; per_night='{{ trans("messages.rooms.per_night") }}'; review_text='{{ trans_choice("messages.header.review",1) }}'; reviews_text='{{ trans_choice("messages.header.review",2) }}';">
                        <div class="outer-listings-container row-space-2" ng-cloak>

                            <div class="listings-container">
                                <div class="">

                                    <div class="col-sm-12 row-space-2 col-md-4 col-sm-6 col-xs-12 hover-list-img"
                                         ng-repeat="rooms in room_result.data" ng-cloak>
                                        <div class="listing list_view" ng-mouseover="on_mouse($index);"
                                             ng-mouseleave="out_mouse($index);" data-room_id="@{{rooms.id}}">
                                            ...
                                            <div class="panel-image listing-img">
                                                <div class="listing-description wl-data-@{{ rooms.id }}">
                                                    <div class="summary">
                                                        <p>
                                                            @{{ rooms.summary }}
                                                            <a href="{{ url('s') }}/@{{ location }}?checkin=@{{ checkin }}&checkout=@{{ checkout }}&guests=@{{ guests }}"
                                                               id="tooltip-sticky-@{{ rooms.id }}"
                                                               class="learn-more">{{ trans('messages.search.learn_more') }}
                                                            </a>
                                                        </p>
                                                ...
                                                <a href="{{ url('rooms') }}/@{{ rooms.id }}?checkin=@{{checkin}}&checkout=@{{checkout}}&guests=@{{ guests }}"
                                                   target="listing_@{{ rooms.id }}" class="media-photo media-cover">
                                                    <div class="listing-img-container media-cover text-center">
                                                        <img id="rooms_image_@{{ rooms.id}}"
                                                             ng-src="@{{ rooms.photo_name }}"
                                                             class="img-responsive-height" alt="@{{ rooms.name }}">
                                                    </div>
                                                </a>

                                                <div class="target-prev target-control rooms-slider block-link"
                                                     data-room_id="@{{rooms.id}}">
                                                    <i class="icon icon-chevron-left icon-size-2 icon-white"></i>
                                                </div>
                                                <div class="target-next target-control rooms-slider block-link"
                                                     data-room_id="@{{rooms.id}}">
                                                ...
                                                <div class="panel-overlay-top-right wl-social-connection-panel">
                                                    <span class="rich-toggle wish_list_button wishlist-button not_saved">
                                                        <input type="checkbox" id="wishlist-widget-@{{ rooms.id }}" name="wishlist-widget-@{{ rooms.id }}"
                                                           data-for-hosting="@{{ rooms.id }}" ng-checked="rooms.saved_wishlists">
                                                        ...
                                                        <i class="icon icon-heart-alt icon-white icon-size-2" data-what="{{$current_refinement}}"
                                                            id="wishlist-widget-icon-@{{ rooms.id }}" data-room_id="@{{ rooms.id }}"
                                                            data-img="@{{ rooms.photo_name }}" data-name="@{{ rooms.name }}"
                                                            data-address="@{{ rooms.rooms_address.city }}"
                                                            data-price="@{{ rooms.rooms_price.currency.symbol }}@{{ rooms.rooms_price.night }}"
                                                            data-review_count="" data-host_img="@{{ rooms.users.profile_picture.src }}" data-star_rating=""
                                                            data-summary="@{{ rooms.summary }}" data-room_type="@{{ rooms.room_type_name }}"
                                                            data-property_type_name="@{{ rooms.property_type_name }}" data-person_capacity_string=""
                                                            data-bedrooms_string="" data-space_tab_content="" data-neighborhood_tab_content=""></i>
                                            ...
                                            <div class="panel-body panel-card-section">
                                                <div class="media nt_media">
                                                    ...
                                                    <a href="{{ url('rooms') }}/@{{ rooms.id }}?checkin=@{{ checkin }}&checkout=@{{ checkout }}&guests=@{{ guests }}"
                                                       target="listing_@{{ rooms.id }}" class="text-normal">
                                                        <h3 title="@{{ rooms.name }}" itemprop="name"
                                                    ...
                                                    <div class="exp_price">
                                                        ...
                                                        <span ng-if="guests>1 && guests>rooms.rooms_price.guests"
                                                              ng-bind-html="rooms.rooms_price.night+(rooms.rooms_price.additional_guest*(guests-rooms.rooms_price.guests))"></span>
                                                        <span ng-if="guests==1 || guests<=rooms.rooms_price.guests"
                                                              ng-bind-html="rooms.rooms_price.night"></span>
                                                    ...
                                                    <div itemprop="description"
                                                         class="pull-left text-muted listing-location text-truncate nt_star">
                                                        <a href="{{ url('rooms') }}/@{{ rooms.id }}?checkin=@{{ checkin }}&checkout=@{{ checkout }}&guests=@{{ guests }}"
                                                           class="text-normal link-reset pull-left">
                                                            <span class="pull-left" ng-show="rooms.overall_star_rating">
                                                                <span class="pull-left"
                                                                      ng-bind-html="rooms.overall_star_rating"></span>
                                                            </span>
                                                            <span class="pull-left" ng-show="rooms.reviews_count">
                                                                <span class="pull-left dot-cont">·</span>
                                                                <span class="pull-left r-count">@{{ rooms.reviews_count }} </span>
                                                                <span class="pull-left r-label">
                                                                    {{ trans_choice('messages.header.review',1) }}@{{ (rooms.reviews_count > 1) ? 's' : '' }}
                                                                </span>
                                                            </span>
                                                        </a>
                                                    </div>
                        ...
                        <div class="results-footer">
                            <div class="pagination-buttons-container row-space-8" ng-cloak>
                                <div class="results_count">
                                    <p>
                                        ...
                                        @{{ room_result.to }} {{ trans('messages.search.of') }} @{{ room_result.total
                                        }} {{ trans('messages.search.rentals') }}
                                    </p>
                                </div>
                                <div>
                            ...
                            <div class="nearby-links"
                                 ng-style="{'visibility': room_result.data[0].rooms_address.country_name == '' ?'visible':'hidden'}">
                                <div class="breadcrumbs row-space-top-1" itemprop="breadcrumb" ng-cloak>
                                    <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                                        <a href="{{ url('s?location=') }}@{{ room_result.data[0].rooms_address.country_name }}"
                                           itemprop="url">
                                            <span itemprop="title"
                                                  ng-if="room_result.data[0].rooms_address.country_name != ''">
                                                @{{ room_result.data[0].rooms_address.country_name }}
                                                <i class="icon icon-chevron-right breadcrumb-spacer"></i>
                                                <i class="icon icon-chevron-left breadcrumb-spacer1" style="display: none;"></i>
                                            </span>
                                        </a>
                                    </span>
                                    <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                                      <a href="{{ url('s?location=') }}@{{ room_result.data[0].rooms_address.state }}-@{{ room_result.data[0].rooms_address.country_name }}"
                                         itemprop="url">
                                        <span itemprop="title" ng-if="room_result.data[0].rooms_address.state != ''">
                                            @{{ room_result.data[0].rooms_address.state }}
                                            <i class="icon icon-chevron-right breadcrumb-spacer"></i>
                                            <i class="icon icon-chevron-left breadcrumb-spacer1"
                    ...
                    <div class="container_1r1rje newbt" style="bottom:20px;">
                        <div class="container_1xmexls">
                            <button type="button" class="button_ipunk">
                                <span>{{ trans('messages.search.map') }}</span>
                            </button>
                            <button type="button" class="button_ipunk4 gut1">
                                <span>{{ trans('messages.search.filters') }}</span>
                            </button>
                        </div>
                    </div>
                    <div class="panel-btn-sm hide filters-btn fixed">
                        <button class="js-small-filter-toggle btn btn-large btn-block btn-primary">
                            {{ trans('messages.search.filters') }}
                        </button>
                    </div>
                </div>
                    ...
                    <div class="nw_more">
                        <div class="moreroom">
                            ...
                            <div class="avairoom">
                                ...
                                <div class="valunum1" ng-init="search_bedrooms = {{$bedrooms >0 ? $bedrooms : 0}}">
                                    <button ng-disabled="search_bedrooms==0" class="value-button"
                                            ng-click="search_bedrooms = search_bedrooms - 1">-
                                    </button>
                                    <input type="text" class="search_bedrooms" ng-value="search_bedrooms+'+'"
                                           readonly=""/>
                                    <button ng-disabled="search_bedrooms==10" class="value-button"
                                            ng-click="search_bedrooms = search_bedrooms-0 + 1">+
                                    </button>
                                </div>
                            </div>
                            <div class="avairoom" ng-init="search_beds = {{$beds > 0 ? $beds : 0}}">
                                ...
                                <div class="valunum1">
                                    <button ng-disabled="search_beds==0" class="value-button"
                                            ng-click="search_beds = search_beds - 1">-
                                    </button>
                                    <input type="text" class="search_beds" value="@{{ search_beds+'+' }}" readonly=""/>
                                    <button ng-disabled="search_beds==16" class="value-button"
                                            ng-click="search_beds = search_beds-0 + 1">+
                                    </button>
                                </div>
                            </div>
                            <div class="avairoom" ng-init="search_bath = {{$bathrooms > 0 ? $bathrooms : 0}}">
                                ...
                                <div class="valunum1">
                                    <button ng-disabled="search_bath==0" class="value-button"
                                            ng-click="search_bath = search_bath - 0.5">-
                                    </button>
                                    <input type="text" class="search_bath" value="@{{ search_bath+'+' }}" readonly=""/>
                                    <button ng-disabled="search_bath==8" class="value-button"
                                            ng-click="search_bath = search_bath-0 + 0.5">+
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="amti">
                            ...
                            <div class="amtmore">
                                ...
                                <div class="seead seead2">
                                    <div class="seeallame">{{ trans('messages.header.seeall') }} {{ trans('messages.lys.property_type') }}</div>
                                    <div class="cls">{{ trans('messages.home.close') }} {{ trans('messages.lys.property_type') }}</div>
                                    <span><i class="fa fa-angle-down" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="morebot">
                            <div class="holebot">
                                <a href="javascript:void(0)" class="gut"
                                   ng-click="reset_filters('more_filters')">{{ trans('messages.your_reservations.cancel') }}
                                </a>
                                <a href="javascript:void(0)" ng-click="apply_filters('more_filters')"
                                   class="seehome">{{ trans('messages.wishlist.see_homes') }}
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <button class="hide-sm btn footer-toggle btn_alt btn_padd">
                <span class="open-content">
                    <i class="icon icon-globe ico_left"></i>
                    {{ trans('messages.search.language_currency') }}
                </span>
                <span class="close-content">
                    <i class="icon icon-remove ico_left"></i>
                    {{ trans('messages.home.close') }}
                </span>
            </button>
        </div>
        <div id="js-ib-icon-tooltip" class="tooltip tooltip-left-middle ib-icon-tooltip" role="tooltip"
             aria-hidden="true">
                        ...
                        <div class="wl-modal">
                            <div class="row row-margin-zero">
                                <div class="col-lg-7 wl-modal__col">
                                    <div class="media-cover media-cover-dark background-cover background-listing-img"
                                         style="background-image:url();">
                                    </div>
                                    <div class="panel-overlay-top-left text-contrast wl-modal-listing-tabbed">
                                        <div class="va-container media">
                                            <img class="pull-left host-profile-img media-photo media-round space-2"
                                                 height="67" width="67" src="">
                                            <div class="media-body va-middle">
                                                ...
                                                <div class="wl-modal-listing__rating-container">
                                                    <span class="hide">
                                                        ...
                                                        <span> · </span>
                                                        <span class="wl-modal-listing__text"></span>
                                                        <span> · </span>
                                                    </span>
                                ...
                                <div class="col-lg-5 wl-modal__col">
                                    <div class="panel-header panel-light wl-modal__header">
                                        <div class="va-container va-container-h va-container-v">
                                            <div class="va-middle">
                                                ...
                                                <a class="modal-close wl-modal__modal-close"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wl-modal-wishlists">
                                        <div class="panel-body panel-body-scroll wl-modal-wishlists__body wl-modal-wishlists__body--scroll">
                                            ...
                                            <div class="wl-modal-wishlist-row clickable"
                                                 ng-repeat="item in wishlist_list"
                                                 ng-class="(item.saved_id) ? 'text-dark-gray' : 'text-gray'"
                                                 ng-click="wishlist_row_select($index)" id="wishlist_row_@{{ $index }}">
                                                <div class="va-container va-container-v va-container-h">
                                                    ...
                                                    <div class="va-middle text-right">
                                                        <div class="h3 wl-modal-wishlist-row__icons">
                                                            <i class="icon icon-heart-alt icon-light-gray wl-modal-wishlist-row__icon-heart-alt"
                                                               ng-hide="item.saved_id"></i>
                                                            <i class="icon icon-heart icon-rausch wl-modal-wishlist-row__icon-heart"
                                                               ng-show="item.saved_id"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel-footer wl-modal-footer clickable">
                                            <form class="wl-modal-footer__form hide">
                                                <strong>
                                                    <div class="pull-left text-lead va-container va-container-v">
                                                        <input type="text"
                                                               class="wl-modal-footer__text wl-modal-footer__input"
                                                               autocomplete="off" id="wish_list_text" value=""
                                                               placeholder="Name Your Wish List" required>
                                                    </div>
                                                    <div class="pull-right">
                                                        <button id="wish_list_btn"
                                                                class="btn btn-flat wl-modal-wishlists__footer__save-button btn-contrast">
                                            ...
                                            <div class="text-rausch va-container va-container-v va-container-h">
                                                <div class="va-middle text-lead wl-modal-footer__text">
        ...
        <div class="morefit1">
            <div class="cls12">
                <!-- <div class="allfill" ng-click="reset_filters('filters')"><i class="fa fa-times clsfa" aria-hidden="true"></i></div> -->
                <div class="allf text-center">
                    All Filters
                    <span>(@{{filter_btn_text('filters_count')}})</span>
                    <span>
                        <a href="javascript:void(0)" ng-click="reset_filters('filters')"
                           class="clsfa">{{ trans('messages.your_reservations.cancel') }}
                        </a>
                    </span>
                </div>
            </div>
            ...
            <div class="holemore">
                <div class="name34 room-type-filter">
                    ...
                    @foreach($room_types as $row)
                        <div class="foredhole">
                            <div class="checking">
                                <input type="checkbox" value="{{ $row->id }}" id="mob_room_type_{{ $row->id }}"
                                       class="regular-checkbox big-checkbox room-type" {{in_array($row->id, $room_type_selected) ? 'checked' : ''}}/>
                                <label for="mob_room_type_{{ $row->id }}"></label>
                            </div>
                ...
                <div class="moreopt">
                    <div class="checkhole">
                        ...
                        <div class="checkmore">
                            <span class="checkbox " ng-class="instant_book == '1' ? '' : 'sdcheck'">
                          <input type="checkbox" class="edfocus" name="instant_book" id="instant_book"
                                 ng-model="instant_book"
                                 ng-init="instant_book = '{{$instant_book}}'" ng-true-value="'1'" ng-false-value="'0'"/>
                          <label data-on="&#x2714;" data-off="&#x2718;"></label>
                        </span>
                        </div>
                    </div>
                        ...
                        @foreach($property_type_dropdown as $row_property_type)
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="holecheck">
                                        <div class="">
                                            <input type="checkbox" id="mob_property_{{ $row_property_type->id }}"
                                                   value="{{ $row_property_type->id }}"
                                                   class="property_type" {{in_array($row_property_type->id, $property_type_selected) ? 'checked' : ''}} />
                                            <label class="search_check_label"
                                                   for="mob_property_{{ $row_property_type->id }}">{{ $row_property_type->name }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="morebot">
                    <div class="holebot">
                        <a href="javascript:void(0)" ng-click="apply_filters('filters')"
                           class="seehome">{{ trans('messages.wishlist.see_homes') }}</a>
                    </div>
                </div>
            </div>
        ...
        <div class="morefit2">
            <div class="cls12">
                <div class="allfill" ng-click="reset_filters('guests')">
                    <i class="fa fa-times clsfa2" aria-hidden="true"></i>
                </div>
                <div class="allf text-center">
                    {{ trans_choice('messages.home.guest',2) }}
                    <span>
                        <a class="text-right clsfa2" href="javascript:void(0)" ng-click="reset_filters('guests')">
                            {{ trans('messages.your_reservations.cancel') }}
                        </a>
                    </span>
                </div>
            ...
            <div class="adl">
                <div class="forgu">
                    ...
                    <div class="valunum">
                        ...
                        <input type="text" class="guest-select" ng-value="search_guest+'+'" readonly=""/>
                        <button ng-disabled="search_guest==16" class="value-button" id="increase"
                                ng-click="search_guest=search_guest+1" value="Increase Value">+
                        </button>
                    </div>
                </div>
            </div>
            <div class="morebot">
                <div class="holebot">
                    <a href="javascript:void(0)" ng-click="apply_filters('guests')"
                       class="seehome">{{ trans('messages.wishlist.see_homes') }}</a>
                </div>
            </div>
        </div>
        ...
        <div class="morefit5">
            <div class="cls12">
                ...
                <div class="allf text-center">
                    ...
                    <span>
                        <a class="text-right clsfa5" href="javascript:void(0)" ng-click="reset_filters('dates')">
                            {{ trans('messages.your_reservations.cancel') }}
                        </a>
                    </span>
                </div>
            ...
            <div class="morebot">
                <div class="holebot">
                    <a href="javascript:void(0)" ng-click="apply_filters('dates')"
                       class="seehome">{{ trans('messages.wishlist.see_homes') }}
                    </a>
                </div>
            </div>
        ...
        <div class="map hide-sm-view">
            ...
            <div class="container_1r1rje newbt" style="bottom:20px;">
                <div class="container_1xmexls">
                    <button type="button" class="button_ipunk-result">
