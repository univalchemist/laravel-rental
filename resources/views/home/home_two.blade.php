                        ...
                        <div class="dateRangePicker_e296pg-o_O-hidden_ajz5vs">
                          ...
                          <div class="container_mv0xzc" style="width: 100%;">
                            ...
                            <div class="save_search">
                              ...
                              <div class="container_mv0xzc save_but_block"><!-- react-text: 18478 --><!-- /react-text --><button type="submit" class="btn btn-primary searchButton_n8fchz">
                      ...
                      <div class="cateimg" ng-repeat="reservation in recommented"><a href=" @{{ url+reservation.id }}"><img ng-src="@{{ reservation.photo_name }}" /></a>
                        ...
                        <div class="panel-body panel-card-section">
                          <div class="media">
                           ...
                           <div class="exp_price">
                            <span ng-bind-html="reservation.rooms_price.currency.symbol"></span>@{{ reservation.rooms_price.night }}
                            {{ trans("messages.rooms.per_night") }}
