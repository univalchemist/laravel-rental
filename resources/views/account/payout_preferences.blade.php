        ...
        <thead>
          ...
          @foreach($payouts as $row)
            <tr>
              ...
              <td>
              {{ $row->paypal_email }}  <span class="lang-chang-label">  ({{ $row->currency_code }})</span>
              </td>
              <td>
        ...
        @endif
          <tfoot>
            <tr id="add_payout_method_section">
              <td colspan="4">
                  <a id="add-payout-method-button" class="btn btn-primary pop-striped" href="javascript:void(0);">
...
<div id="taxes"></div>
    ...
    <div class="modal poppayout hide" id="payout_popup1" aria-hidden="false" style="" tabindex="-1"><div class="modal-table"><div class="modal-cell"><div id="modal-add-payout-set-address" class="modal-content">
  <div class="panel-header">
...
<div class="modal poppayout hide" id="payout_popup2" aria-hidden="false" style="" tabindex="-1"><div class="modal-table"><div class="modal-cell"><div id="modal-add-payout-set-address" class="modal-content">
  <div class="panel-header">
    <a data-behavior="modal-close" class="panel-close" href="javascript:void(0);"></a>
    {{ trans('messages.account.add_payout_method') }}
  </div>
...
<div class="modal poppayout hide" id="payout_popup3" aria-hidden="false" style="" tabindex="-1"><div class="modal-table"><div class="modal-cell"><div id="modal-add-payout-set-address" class="modal-content">
  <div class="panel-header">
    <a data-behavior="modal-close" class="panel-close" href="javascript:void(0);"></a>
    {{ trans('messages.account.add_payout_method') }}
  </div>
...
<div class="modal poppayout hide" id="payout_popupstripe" aria-hidden="false" style="" tabindex="-1"><div class="modal-table"><div class="modal-cell"><div id="modal-add-payout-set-address" class="modal-content">
  <div class="panel-header">
    <a data-behavior="modal-close" class="panel-close" href="javascript:void(0);"></a>
    {{ trans('messages.account.add_payout_method') }}
  </div>
