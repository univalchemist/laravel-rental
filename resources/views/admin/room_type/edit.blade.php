        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Room Type Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['url' => ADMIN_URL.'/edit_room_type/'.$result->id, 'class' => 'form-horizontal','id'=>'form']) !!}
...
@endforeach
                ...
                <div class="form-group">
                  <label for="input_is_shared" class="col-sm-3 control-label">Is Shared Room?<em class="text-danger">*</em></label>

                  <div class="col-sm-6">
                    {!! Form::select('is_shared', array('Yes' => 'Yes', 'No' => 'No'), $result->is_shared, ['class' => 'form-control required', 'id' => 'input_is_shared', 'placeholder' => 'Select']) !!}                    
                  </div>
                </div>
                ...
                <div class="form-group status">
                  ...
                  <div class="col-sm-6">
                    ...
                    <em class="text-danger status_error" style="font-size: 14px;" hidden="hidden" >Must choose Active(Atleast One Roomtype in 'Active')</em>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
...
{!! Html::script('js/jquery-1.11.3.js') !!}
    ...
    $(document).ready(function() {
      $('#input_status').change(function(){
        ...
        $.ajax({
          type: "post",
          url: '{{ url("/") }}/'+ADMIN_URL+'/status_check/'+status_id,
