    ...
    public function update(Request $request)
    {
        if(!$_POST)
        {
            $data['result'] = Reviews::join('rooms', function($join) {
                        ...
                        ->where('reviews.id',$request->id)->where('list_type' , 'Rooms')->select(['reviews.id as id', 'reservation_id', 'rooms.name as room_name', 'users.first_name as user_from', 'users_to.first_name as user_to', 'review_by', 'comments'])->get();
