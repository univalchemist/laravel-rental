        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Room Type Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => ADMIN_URL.'/add_room_type', 'class' => 'form-horizontal','id'=>'form']) !!}
              <div class="box-body">
              ...
              <div class="multiple_lang" >
               ...
               <div class="multiple_lang_add">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::select('is_shared', array('Yes' => 'Yes', 'No' => 'No'), '', ['class' => 'form-control required', 'id' => 'input_is_shared', 'placeholder' => 'Select']) !!}                    
                  </div>
                </div>
