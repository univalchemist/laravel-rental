    ...
    public function ajax()
    {
        ...
        return $this->datatables
            ...
            ->addColumn('action', function ($help_subcategory) {   
                return '<a href="'.url(ADMIN_URL.'/edit_help_subcategory/'.$help_subcategory->subcategory_id).'" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;<a data-href="'.url(ADMIN_URL.'/delete_help_subcategory/'.$help_subcategory->subcategory_id).'" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#confirm-delete"><i class="glyphicon glyphicon-trash"></i></a>';
            })
            ->make(true);
    }
